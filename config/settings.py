...
# Parâmetros globais de fila (podem virar model de config editável no admin depois)
FILA_TAMANHO_LOTE_PADRAO = config('FILA_TAMANHO_LOTE_PADRAO', default=5, cast=int)
FILA_FREQUENCIA_SEGUNDOS = config('FILA_FREQUENCIA_SEGUNDOS', default=60, cast=int)
